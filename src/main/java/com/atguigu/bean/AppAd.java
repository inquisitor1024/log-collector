...
public class AppAd {
    ...
    //动作: 请求广告=1 取缓存广告=2 广告位展示=3 广告位展示=4 广告位点击=5
    ...
    //Type: 1- 图文 2-图集 3-段子 4-GIF 5-视频 6-调查
    //7-纯文 8-视频+图文 9-GIF+图文 0-其他
    private String newstype;
    //内容样式: 无图(纯文字)=6 一张大图=1 三张小图+文 =4 一张大图+两张小图+文=3
    //图集+文 =5 一张大图+文=11 GIF大图+文=12 视频(大图)+文=13
    //来源于详情页相关推荐的商品，上报样式都为0（因为都是左右图）
